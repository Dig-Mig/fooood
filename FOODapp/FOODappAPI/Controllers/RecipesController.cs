...
namespace FOODappAPI.Controllers
{
    ...
    [ApiController]
    public class RecipesController(IRecipeRepository recipeRepository, IMapper mapper) : ControllerBase
    {
        private readonly IRecipeService _recipeService = new RecipeService(recipeRepository,mapper);
        ...
        public async Task<IEnumerable<RecipeDTO>> Get()
        {
            ...
            var dto = mapper.Map<IEnumerable<RecipeDTO>>(recipes);
            return dto;
        }
        ...
        public async Task<IActionResult> Get(int id)
        {
            ...
            return recipe == null ? Problem() : Ok(mapper.Map<RecipeDTO>(recipe));
        }
        ...
        {
            var recipe = mapper.Map<Recipe>(recipeUpdateDTO); 
        ...
        public async Task<IActionResult> Put(int id, [FromBody] RecipeUpdateDTO recipeUpdateDtoDTO)
        {
            ...
            return recipe == null ? NotFound() : Ok(mapper.Map<RecipeDTO>(recipe));
        }
